...
>>>>>>> 95fd6f6 (condition page completed)
          ...
          <li>
<<<<<<< HEAD
            <Link to="/new" className="text-xl font-semibold hover:text-primary">New</Link>
=======
...
>>>>>>> 95fd6f6 (condition page completed)
      ...
      <div className="navbar-end md:pe-5">
          ...
          <div className="dropdown dropdown-end">
            ...
            <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
              <div className="w-10 rounded-full">
                <img
                  alt="Tailwind CSS Navbar component" className="bg-red-600"
            ...
            <ul
              ...
              <li><Link onClick={logoutHandler} className="bg-red-500 text-white hover:bg-red-400 w-[40%] text-end ms-auto">Logout</Link></li>
        ...
        {/*  add to cart button */}
        <Link to="/cart" className="flex items-center md:text-xl font-semibold md:mx-4"><FaCartShopping />Cart  {cartItems.length>0 && <div className="badge badge-warning ">{cartItems.length}</div>}</Link>
